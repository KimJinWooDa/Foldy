...
namespace Foldy
{
    ...
    {
        [Header("규칙 정보")] public string name = "";
        public string pattern = "";

        [TextArea(2, 4)] public string description = "";

        [Header("설정")] public bool isRequired = true;

        [Header("예시")] [TextArea(1, 3)] public string goodExample = "";

        [TextArea(1, 3)] public string badExample = "";
