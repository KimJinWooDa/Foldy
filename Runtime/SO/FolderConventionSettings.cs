...
namespace Foldy
{
    ...
    {
        [Header("📁 폴더 정보")] public string folderPath = "Assets/";
        ...
        [Header("📝 네이밍 규칙")] public string prefix = "";
        public string suffix = "";
        public NamingStyle namingStyle = NamingStyle.PascalCase;
        public bool enforceNaming = true;

        [Header("🎯 특수 규칙")] public bool isProjectSpecific = false;
        public string projectPrefix = "";

        [Header("🔧 파일 타입 규칙")] public List<string> allowedExtensions = new List<string>();
        public bool autoCapitalize = true;
        public bool removeSpecialChars = true;
        public bool preserveNumbers = true;

        [Header("⚡ 자동 처리")] public bool autoApply = false;
    ...
    {
        [Header("🎯 전역 설정")] [SerializeField] private bool enableFolderConventions = true;
        ...
        [Header("📁 폴더별 컨벤션")] [SerializeField]
        private List<FolderConvention> folderConventions = new List<FolderConvention>();

        [Header("🚫 전역 제외 설정")] [SerializeField]
        private List<string> globalExcludeFolders = new List<string>
        {
        ...
        // 캐시
        private Dictionary<string, FolderConvention>
            _pathToConventionCache = new Dictionary<string, FolderConvention>();
